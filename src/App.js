    ...
    return (
      <Router>
        <div>
          ...
          />
          <Routes>
            <Route exact path='/' element={<News setProgress={this.setProgress} key="General" pageSize={6} country={"in"} category={"General"}></News>}></Route>
            <Route exact path='/General' element={<News setProgress={this.setProgress} key="General" pageSize={6} country={"in"} category={"General"}></News>}></Route>
